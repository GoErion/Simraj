<x-guest>
    <div>
        <div class="bg-transparent">
            <main>
                <!-- Hero section -->
                <div class="relative isolate overflow-hidden bg-transparent pt-14 pb-16 sm:pb-20">
                    ...
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                                <div class="relative rounded-full px-3 py-1 ring-1 ring-white/10 hover:ring-white/20">
                ...
                <div class="mt-32 sm:mt-56">
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-2xl sm:text-center">
                            ...
                            <p class="mt-2 text-4xl tracking-tight text-pretty sm:text-5xl sm:text-balance">No server? No problem.</p>
                        ...
                        <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                            <figure class="relative isolate pt-6 sm:pt-12">
                                ...
                                <figcaption class="mt-8 text-base">
                                    <div class="font-semibold text-white">Ke Erion</div>
                                    <div class="mt-1 text-gray-400">CEO of GoErion</div>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                ...
                <!-- Pricing section -->
                <div class="relative isolate mt-32 bg-transparent px-6 sm:mt-56 lg:px-8">
                    ...
                    <div class="mx-auto max-w-2xl sm:text-center">
                        <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty sm:text-5xl sm:text-balance">Choose the right product for you</p>
                        <p class="mt-6 text-lg/8 text-gray-600">Choose an affordable product that’s packed with the best features for engaging your audience, creating customer loyalty, and driving sales.</p>
                    </div>
                ...
                <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
                    <div class="mx-auto max-w-4xl">
                        <h2 class="text-4xl font-semibold tracking-tight sm:text-5xl">Frequently asked questions</h2>
                        <dl class="mt-16 divide-y divide-gray-900/10">
                            <div class="py-6 first:pt-0 last:pb-0">
                                <dt>
                                    <!-- Expand/collapse question button -->
                                    <button type="button" class="flex w-full items-start justify-between text-left" aria-controls="faq-0" aria-expanded="false">
                                        <span class="text-base/7">What&#039;s the best thing about Switzerland?</span>
